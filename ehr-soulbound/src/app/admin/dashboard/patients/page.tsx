  ...
  return (
    <div className="min-h-screen flex flex-col flex-wrap">
      ...
      <div className="flex flex-col basis-full justify-center items-center">
        <div
          className="w-3/5 grid grid-cols-4 text-center text-[#f2e9e4]/90 md:max-lg:text-[10px] lg:text-sm text-[6px] font-quicksand font-bold md:p-5 p-3 md:rounded-2xl rounded-lg"
