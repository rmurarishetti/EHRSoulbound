  ...
  return (
    <div className="flex">
        ...
        <div className="pt-10 pl-5 mr-auto">
            <Link className="border-[2px] border-[#ffaeae] rounded-full bg-[#f2e9e4] hover:bg-[#eadbd3] hover:border-[#ff9090] py-4 px-4 font-sans text-base font-medium text-[#0B1EB5]" href="/">Add Lab Reports</Link>
        </div>
    </div>
  )
}