    ...
    <Dialog.Root open={open} onOpenChange={handleOpen}>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="data-[state=open]:animate-contentShow fixed top-[50%] left-[50%] max-h-[85vh] w-[90vw] max-w-[450px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-white p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none">
          ...
          <Dialog.Description className="rounded-xl bg-slate-300 text-[#38139F]/80 mb-5 md:text-[15px] text-[8px]">
            <div className="flex m-3 justify-between items-center text-justify">
              <div className="font-medium">
                <InfoCircledIcon />
              </div>
              <div className="my-2">Existing Remarks: {remarks}</div>
            </div>
          </Dialog.Description>
