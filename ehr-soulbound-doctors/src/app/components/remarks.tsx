    ...
    <Dialog.Portal>
      ...
      <Dialog.Content className="data-[state=open]:animate-contentShow fixed top-[50%] left-[50%] max-h-[85vh] w-[90vw] max-w-[450px] translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-white p-[25px] shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px] focus:outline-none">
        ...
        <Dialog.Description className="text-mauve11 mt-[10px] mb-5 text-[15px] leading-normal">
          Add your remarks post reviewing the case for the patient here. Click submit when you&apos;re done.
        </Dialog.Description>
        <Dialog.Description className="text-mauve11 mt-[10px] mb-5 text-[15px] leading-normal">
        ...
        <Form.Field className="mb-[15px] flex items-center gap-5" name="remarks">
          ...
          <Form.Control asChild>
            ...
            value={state.remarks}
            placeholder={state.remarks === "ok" || state.remarks === null ? 'Enter your Remarks' : state.remarks}
            required
            />
          </Form.Control>
          </Form.Field>
