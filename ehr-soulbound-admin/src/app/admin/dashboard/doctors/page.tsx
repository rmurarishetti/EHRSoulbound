  ...
  return (
    <div className="min-h-screen flex flex-col flex-wrap">
      ...
      <div className="flex flex-col basis-full justify-center items-center">
        <div
          className="w-3/5 grid grid-cols-5 text-center text-[#f2e9e4]/90 md:text-sm text-[6px] font-quicksand font-bold md:p-5 p-3 md:rounded-2xl rounded-lg"
        ...
        <div className="w-3/5 md:rounded-2xl rounded-lg bg-[#cff0f9]/70">
          {data.map((doctor, index) => (
            <div
              key={index}
              className="grid grid-cols-5 text-center text-[#0B1E5B] md:text-sm text-[6px] font-quicksand font-bold md:p-5 p-3"
            >
